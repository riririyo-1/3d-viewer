...
| カテゴリ | テスト内容                | 実装状況    | テストファイル                      | テスト数 |
| -------- | ------------------------- | ----------- | ----------------------------------- | -------- |
| **Unit** | Button コンポーネント     | ✅ 実装済み | `src/components/ui/Button.test.tsx` | 3        |
| **Unit** | ユーティリティ関数（cn）  | ✅ 実装済み | `src/lib/utils.test.ts`             | 9        |
| **Unit** | Zustand store（状態管理） | ✅ 実装済み | `src/lib/store.test.ts`             | 18       |
| **Unit** | i18n（国際化）            | ✅ 実装済み | `src/lib/i18n.test.ts`              | 15       |
| **E2E**  | ホーム画面表示            | ✅ 実装済み | `test/e2e/home.spec.ts`             | -        |
| **E2E**  | コレクション画面遷移      | ✅ 実装済み | `test/e2e/collection.spec.ts`       | -        |
| **E2E**  | ファイルアップロード      | 未実装      | -                                   | -        |
| **E2E**  | 3D モデル表示             | 未実装      | -                                   | -        |
